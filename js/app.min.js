...
if (docs) {
   docs.addEventListener("click", function (e) {
      ...
      if (targetElem.classList.contains('docs__item')) {
         if (helpGo) {
            helpGo = false;
      ...
      if (targetElem.classList.contains('docs__more')) {
...
async function getMoreQuestions(targetElem) {
   ...
   if (response.ok) {
      ...
      const helpItems = document.querySelector('.docs__items');
      helpItems.insertAdjacentHTML('beforeend', text);
      targetElem.classList.contains('_loading');
   } else {
...
//$(document).ready(function () {
//   $(".gift-baskets-card").on('click', function (e) {
//      $(this).toggleClass('gift-baskets-card');
//   })
//});
